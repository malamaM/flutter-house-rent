...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${PODS_CONFIGURATION_BUILD_DIR}/flutter_secure_storage_darwin/flutter_secure_storage_darwin.framework"
  install_framework "${PODS_CONFIGURATION_BUILD_DIR}/geolocator_apple/geolocator_apple.framework"
  install_framework "${PODS_CONFIGURATION_BUILD_DIR}/image_picker_ios/image_picker_ios.framework"
  install_framework "${PODS_CONFIGURATION_BUILD_DIR}/path_provider_foundation/path_provider_foundation.framework"
  install_framework "${PODS_CONFIGURATION_BUILD_DIR}/share_plus/share_plus.framework"
  install_framework "${PODS_CONFIGURATION_BUILD_DIR}/shared_preferences_foundation/shared_preferences_foundation.framework"
  install_framework "${PODS_CONFIGURATION_BUILD_DIR}/sqflite_darwin/sqflite_darwin.framework"
  install_framework "${PODS_CONFIGURATION_BUILD_DIR}/url_launcher_ios/url_launcher_ios.framework"
