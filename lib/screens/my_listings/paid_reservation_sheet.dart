    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          ...
          Expanded(
            child: Text(
              'Customers pay a refundable down payment to show they are serious. A live refund may exclude the mobile-money provider fee; this demo applies no fee. Haven simulates Airtel Money and MTN Money for now; viewing requests continue as normal. Manage your receiving numbers once in Account settings and reuse them across all listings.',
  ...
  Widget _moneySettings(BuildContext context) {
    ...
    return Column(
      children: [
        ...
        _profilePaymentSettingsLink(context),
      ],
    );
  }

  Widget _profilePaymentSettingsLink(BuildContext context) {
    final colors = Theme.of(context).colorScheme;
    return Container(
      width: double.infinity,
        ...
        children: [
          ...
          Expanded(
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Text('Receiving numbers are in your profile',
                    style: TextStyle(
                        color: colors.onSurface, fontWeight: FontWeight.w800)),
                const SizedBox(height: 3),
                Text(
                  'One Airtel Money and MTN Money number can receive payments for every listing you own.',
                  style: TextStyle(
                ...
                Align(
                  ...
                  child: TextButton.icon(
                    onPressed: () => Navigator.of(context).push(HavenPageRoute(
                        builder: (_) => const MobileMoneySettingsScreen())),
                    icon: const Icon(Icons.settings_outlined, size: 17),
                    label: const Text('Manage in Account settings'),
